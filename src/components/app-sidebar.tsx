...
const navStructure: NavGroup[] = [
    {
        items: [
            { name: "Accounts", href: "/accounts", icon: Users, iconClass: "text-indigo-500", translationKey: 'adsManager.accounts' },
            { name: "Campaigns", href: "/campaigns", icon: Megaphone, iconClass: "text-fuchsia-500", translationKey: 'adsManager.campaigns' },
            { name: "Google Sheets Export", href: "/google-sheets-export", icon: FileSpreadsheet, iconClass: "text-green-500", translationKey: 'nav.googleSheetsExport' },
            {
                name: "Settings",
                icon: Settings,
