...
const FacebookIcon = () => (
    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="#1877F2">
        <path d="M24 12c0-6.627-5.373-12-12-12S0 5.373 0 12c0 5.99 4.388 10.954 10.125 11.854V15.47H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956-.925-1.956-1.874V12h3.328l-.532 3.47h-2.796v8.385C19.612 22.954 24 18.062 24 12z" />
    </svg>
);
...
function LoginPageContent() {
    ...
    const handleFacebookSignIn = async () => {
        setLoading('facebook');
        await signIn('facebook', { callbackUrl: "/accounts" });
    };
